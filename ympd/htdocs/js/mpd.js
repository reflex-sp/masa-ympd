...
function systemMount() {
    socket.send('SYSTEM_MOUNT');
    $('.top-right').notify({
        message:{text:"z-mpd nas mount... "}
    }).show();
}

function systemReboot() {
    socket.send('SYSTEM_REBOOT');
    $('.top-right').notify({
        message:{text:"z-mpd reboot... "}
    }).show();
}

function systemPowerOff() {
    socket.send('SYSTEM_POWEROFF');
    $('.top-right').notify({
        message:{text:"z-mpd shutdown... "}
    }).show();
}
